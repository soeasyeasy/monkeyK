...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'ai'">
      <path
        d="M12 2a8 8 0 0 0-8 8v2a8 8 0 0 0 5 7.4V22l3-2 3 2v-2.6A8 8 0 0 0 20 12v-2a8 8 0 0 0-8-8z"
      />
    ...
    <template v-else-if="name === 'brain'">
      ...
      <path d="M10 22h4" />
      <path
        d="M12 2a7 7 0 0 0-7 7c0 2.5 1.5 4.5 3.5 5.5V16h7v-1.5c2-1 3.5-3 3.5-5.5a7 7 0 0 0-7-7z"
      />
    </template>
