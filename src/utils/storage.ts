...
import type { Todo, Habit, Expense, Goal, UserSettings } from '../types/workspace'
...
// 获取存储统计
export function getStorageStats(): { todos: number; habits: number; expenses: number; goals: number } {
  return {
